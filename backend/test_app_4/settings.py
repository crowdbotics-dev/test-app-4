"""
Django settings for test_app_4 project.
...
WSGI_APPLICATION = 'test_app_4.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "test_app_4 API",
    "DESCRIPTION": "API documentation for test_app_4 App",
    "VERSION": "v1",
}
